...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        log.info("Connecting to Database: {}", primaryUrl);
        try {
            ...
            fallbackConfig.setJdbcUrl("jdbc:h2:mem:healthbridge_cloud_db;MODE=PostgreSQL;DATABASE_TO_LOWER=TRUE;DB_CLOSE_DELAY=-1");
